...
export default function Contact() {
  ...
  const field = 'w-full h-11 bg-white border border-black/10 rounded-lg px-3 text-sm outline-none focus:border-[#FC6061] transition-colors';
    ...
    <MarketingLayout>
      ...
      <section className="px-5 md:px-10 pb-20 max-w-5xl mx-auto grid md:grid-cols-5 gap-8">
        ...
        <div className="md:col-span-2 space-y-4">
          <a href="tel:+250788500266" className="flex items-center gap-3 rounded-xl border border-black/8 p-4 hover:shadow-md transition-all">
            <Phone className="w-5 h-5" style={{ color: CORAL }} /><div><p className="text-[11px] font-bold uppercase tracking-wide text-[#161616]/50">Phone / WhatsApp</p><p className="font-semibold" style={{ color: INK }}>+250 788 500 266</p></div>
          </a>
          <a href="mailto:inspectafrica@gmail.com" className="flex items-center gap-3 rounded-xl border border-black/8 p-4 hover:shadow-md transition-all">
            <Mail className="w-5 h-5" style={{ color: CORAL }} /><div><p className="text-[11px] font-bold uppercase tracking-wide text-[#161616]/50">Email</p><p className="font-semibold" style={{ color: INK }}>inspectafrica@gmail.com</p></div>
          </a>
          <div className="flex items-center gap-3 rounded-xl border border-black/8 p-4">
            <MapPin className="w-5 h-5" style={{ color: CORAL }} /><div><p className="text-[11px] font-bold uppercase tracking-wide text-[#161616]/50">Location</p><p className="font-semibold" style={{ color: INK }}>Kigali, Rwanda</p></div>
          </div>
        ...
        <div className="md:col-span-3">
          {sent ? (
            ...
            <form onSubmit={submit} className="rounded-2xl border border-black/8 p-6 space-y-3">
              ...
              <textarea required placeholder="Message *" value={form.message} onChange={set('message')} rows={5} className="w-full bg-white border border-black/10 rounded-lg px-3 py-2 text-sm outline-none focus:border-[#FC6061] transition-colors resize-none" />
