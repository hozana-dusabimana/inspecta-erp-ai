  ...
  [AppView.PLANNING]: {
    ...
    tabs: [
      ...
      },
      {
        ...
        fields: [
          { name: 'reference', label: 'Reference', required: true, section: 'Contract' },
          ...
          { name: 'currency', label: 'Currency (e.g. RWF)', section: 'Commercials' },
          { name: 'defectsLiabilityMonths', label: 'Defects Liability (months)', type: 'number', section: 'Commercials' },
          { name: 'retentionPct', label: 'Retention %', type: 'number', section: 'Commercials' },
          { name: 'advancePayment', label: 'Advance Payment', type: 'number', section: 'Commercials' },
          { name: 'contractDate', label: 'Contract Date', type: 'date', section: 'Dates' },
          { name: 'commencementDate', label: 'Commencement Date', type: 'date', section: 'Dates' },
          { name: 'signedDate', label: 'Signed Date', type: 'date', section: 'Dates' },
          { name: 'startDate', label: 'Start Date', type: 'date', section: 'Dates' },
          { name: 'endDate', label: 'End Date', type: 'date', section: 'Dates' },
        ],
      },
      {
    ...
    tabs: [
      {
        ...
        fields: [
          ...
          { name: 'employeeNo', label: 'Employee No. (auto)', hideOnCreate: true, readOnly: true, section: 'Personal' },
          { name: 'nationalId', label: 'National ID', section: 'Personal' },
          { name: 'phone', label: 'Phone', section: 'Personal' },
          { name: 'email', label: 'Email', section: 'Personal' },
          { name: 'tradeId', label: 'Trade', type: 'select', optionsEndpoint: '/hr/trades', optionLabel: (r) => r.name, section: 'Assignment' },
          { name: 'crewId', label: 'Crew', type: 'select', optionsEndpoint: '/hr/crews', optionLabel: (r) => r.name, section: 'Assignment' },
          { name: 'projectId', label: 'Project', type: 'select', optionsEndpoint: '/projects', optionLabel: (r) => `${r.code} — ${r.name}`, section: 'Assignment' },
          { name: 'status', label: 'Status', type: 'select', options: opt(['active', 'on_leave', 'terminated']), section: 'Assignment' },
          { name: 'hireDate', label: 'Hire Date', type: 'date', section: 'Assignment' },
          { name: 'dailyWage', label: 'Daily Wage', type: 'number', section: 'Pay & Statutory' },
          { name: 'grossMonthlySalary', label: 'Gross Monthly Salary (payroll)', type: 'number', section: 'Pay & Statutory' },
          { name: 'medicalScheme', label: 'Medical Scheme', type: 'select', options: opt(['rama', 'private', 'none']), section: 'Pay & Statutory' },
          { name: 'bankAccountNumber', label: 'Bank Account Number', section: 'Pay & Statutory' },
          { name: 'skills', label: 'Skills (comma-separated)', type: 'csv', placeholder: 'Formwork, Rebar', section: 'Skills' },
          { name: 'certifications', label: 'Certifications (comma-separated)', type: 'csv', section: 'Skills' },
        ],
      },
      {
    ...
    tabs: [
      {
        ...
        fields: [
          { name: 'name', label: 'Equipment Name', required: true, section: 'Equipment' },
          { name: 'code', label: 'Code (auto)', hideOnCreate: true, readOnly: true, section: 'Equipment' },
          { name: 'categoryId', label: 'Category', type: 'select', optionsEndpoint: '/equipment/categories', optionLabel: (r) => r.name, section: 'Equipment' },
          { name: 'fuelType', label: 'Fuel Type', type: 'select', options: opt(['diesel', 'petrol', 'electric', 'none']), section: 'Equipment' },
          { name: 'ownershipStatus', label: 'Ownership', type: 'select', options: opt(['OWNED', 'RENTED', 'LEASED']), section: 'Status & Assignment' },
          { name: 'status', label: 'Status', type: 'select', options: opt(['AVAILABLE', 'IN_USE', 'MAINTENANCE', 'IDLE', 'DECOMMISSIONED']), section: 'Status & Assignment' },
          { name: 'primaryProjectId', label: 'Primary Project', type: 'select', optionsEndpoint: '/projects', optionLabel: (r) => `${r.code} — ${r.name}`, section: 'Status & Assignment' },
          { name: 'hourlyRate', label: 'Hourly Rate', type: 'number', section: 'Rates' },
          { name: 'dailyRate', label: 'Daily Rate', type: 'number', section: 'Rates' },
        ],
      },
      {
    ...
    tabs: [
      {
        ...
        fields: [
          ...
          { name: 'rating', label: 'Rating (0-5)', type: 'number', section: 'Performance' },
