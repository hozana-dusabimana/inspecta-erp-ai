...
export const MODULES: Record<string, ModuleDef> = {
  [AppView.PLANNING]: {
    ...
    subtitle: 'Work Breakdown Structure & Bill of Quantities (Module 1)',
    tabs: [
      {
        ...
        columns: [
          ...
          { key: 'level', label: 'Level' }, { key: 'weightPct', label: 'Weight %', align: 'right' },
        ],
        fields: [
          { name: 'code', label: 'Code', required: true }, { name: 'name', label: 'Name', required: true },
          { name: 'level', label: 'Level', type: 'number' }, { name: 'weightPct', label: 'Weight %', type: 'number' },
        ],
      },
      {
        ...
        fields: [
          { name: 'code', label: 'Code', required: true }, { name: 'description', label: 'Description', required: true },
          { name: 'unit', label: 'Unit' }, { name: 'quantity', label: 'Quantity', type: 'number', required: true },
    ...
    tabs: [
      {
        ...
        fields: [
          ...
          { name: 'predecessors', label: 'Predecessor codes (comma-separated)', type: 'csv', placeholder: 'A10, A20' },
