...
export default function About() {
  return (
    <MarketingLayout>
      ...
      <section className="px-5 md:px-10 pb-8 max-w-3xl mx-auto space-y-5 text-[var(--mk-muted)] leading-relaxed">
      ...
      <section className="px-5 md:px-10 py-12 max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-[var(--mk-border)] p-7">
          <Compass className="w-7 h-7 mb-3" style={{ color: CORAL }} />
          <h3 className="text-lg font-bold" style={{ color: INK }}>Our Vision</h3>
          <p className="mt-2 text-sm text-[var(--mk-muted)]">To be the region's most trusted quality control partner in the construction industry.</p>
        </div>
        <div className="rounded-2xl border border-[var(--mk-border)] p-7">
          <Target className="w-7 h-7 mb-3" style={{ color: CORAL }} />
          <h3 className="text-lg font-bold" style={{ color: INK }}>Our Mission</h3>
          <p className="mt-2 text-sm text-[var(--mk-muted)]">To safeguard the quality, safety, and durability of construction projects by delivering accurate laboratory testing, sound structural engineering, and disciplined, technology-enabled project management.</p>
        </div>
      </section>
